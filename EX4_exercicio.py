...
def separar_treino_teste(lista_1, lista_2, divisor=0.8):
    if len(lista_1) != len(lista_2):
        return 'Listas de tamanhos diferentes.'

    separador = int(divisor * len(precos_imoveis))

    lista_1_treino = lista_1[:separador]
    lista_1_teste = lista_1[separador:]

    lista_2_treino = lista_2[:separador]
    lista_2_teste = lista_2[separador:]

    return lista_1_treino, lista_1_teste, lista_2_treino, lista_2_teste

print(*separar_treino_teste(precos_imoveis, tamanho_imoveis), sep='\n\n')
