...
dataframe_path = r'Python Impressionador\Intensivao 2023\Aula 3 - Automacao web\Produtos.xlsx'
...
dataframe_table.to_excel(r'Python Impressionador\Intensivao 2023\Aula 3 - Automacao web\Produtos atualizados.xlsx', index=False)
